...
import com.loncoto.AirlineAnalysisForm.utils.MyJsonOutputFormat;
import com.loncoto.AirlineAnalysisForm.utils.MyXmlOutputFormat;

/**
 * Hello world!
 *
 */
public class SelectAggregationMRJsonjob extends Configured implements Tool
{
    ...
    public static void main( String[] args ) throws Exception
    {
    	...
    	ToolRunner.run(new SelectAggregationMRJsonjob(), args);
    }
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(SelectAggregationMRJsonjob.class);
		
		// formlat fichier en entree/sortie
		job.setInputFormatClass(TextInputFormat.class);
		job.setOutputFormatClass(MyJsonOutputFormat.class);
