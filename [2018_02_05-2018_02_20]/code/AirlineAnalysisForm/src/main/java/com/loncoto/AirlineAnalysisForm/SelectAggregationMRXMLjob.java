 ...
 *
 */
public class SelectAggregationMRXMLjob extends Configured implements Tool
{
    ...
    public static void main( String[] args ) throws Exception
    {
    	...
    	ToolRunner.run(new SelectAggregationMRXMLjob(), args);
    }
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(SelectAggregationMRXMLjob.class);
		
		// formlat fichier en entree/sortie
		job.setInputFormatClass(TextInputFormat.class);
		job.setOutputFormatClass(MyXmlOutputFormat.class);
